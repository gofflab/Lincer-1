...
def find_novel_transcripts(sample, gtf, ref_gtf, gtf_out):
    ...
    x = pd.read_table(gtf, header=None, usecols=[2, 3, 4, 8])
    ...
    t_class_code = _get_cuffcompare_class_codes(ref_gtf, gtf)
    ...
    _filter_gtf_by_transcript(gtf, gtf_out, z.index)
...
for sample, gtf, gtf_out in sample_info.itertuples():
